(function () {
    ...
    angular.module('listaTarefasApp')
    .constant("constates", {TESTE: 'teste constates'}); 

    //CONTROLLER
    angular.module('listaTarefasApp')
        .controller("listaTarefasController", listaTarefasController); 
    
    listaTarefasController.$inject = ['$scope', 'constates'];

    function listaTarefasController($scope, constant) {
        var vm = this;

        vm.teste = constant.TESTE;
